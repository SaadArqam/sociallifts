...
// }) => {
//   // Provide safe defaults for items
//   const menuItems = (Array.isArray(items) && items.length)
//     ? items
//     : [
//         { label: "Work", href: "/#work" },
//         // Link "About" to the AboutComp page
...
//   // Treat hash fragments as internal (do not treat '#' as external)
...
//   return (
//     // center the navbar container horizontally
//     <div className="absolute top-[1em] z-[1000] left-0 right-0 flex justify-center">
//       <nav
//         className={`w-full md:w-max flex items-center justify-center box-border px-4 md:px-0 ${className}`}
//         aria-label="Primary"
//         style={cssVars}
//       >
//         {isRouterLink(menuItems?.[0]?.href) ? (
//           <Link href={menuItems[0].href || "#"} legacyBehavior>
//             <a
//               aria-label="Home"
